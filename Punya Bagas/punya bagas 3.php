...
<tr>
        ...
        <label for="p"><input type="radio" name="jk" id="p" value="Perempuan" >Perempuan
        </label>
        </td>
</tr>
...
<tr>
        ...
        <select name="golongan" required>
            ...
            <option value="4">Golongan 4</option></select>
        </td>
</tr>
...
<tr>
        ...
        <input type="number" name="jamKerja" id="jamkerja" value="173" min="173" required>
            ...
            <button type="submit" name="hitung">JUMLAH
            </button>
    </form>
    </body>
</html>
