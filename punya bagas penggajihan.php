...
<tr>
        <td>
        <label for="bendahara">Nama Bendahara
            </label>
        </td>
        <td>:</td>
        <td><input type="text" name="bendahara" id="bendahara" required>
        </td>
</tr>
<tr>
        <td>
        <label for="pekerja">Nama Pekerja
            </label>
        </td>
        <td>:</td>
        <td><input type="text" name="pekerja" id="pekerja" required>
        </td>
</tr>
...
<tr>
        ...
        <td>
        <label for="l">
        <input type="radio" name="jenis" id="l" value="Laki-laki" >Laki-laki
            </label>

        <label for="p">
        <input type="radio" name="jenis" id="p" value="Perempuan" >Perempuan
            </label>
        </td>
</tr>
...
$jabatan =$_POST['jabatan'];
 ...
 echo "<td></td>";
    ...
    echo "<h2><b>Struk Gaji Karyawan</b><br></h2>";
    echo "-------------------------------------------------------<br>";
...
echo "<tr>";
 ...
 echo "<td></td>";
 echo "<td></td>";
   echo "<td>Bendahara : <b>$bendahara</b></td>";echo "</tr>";
