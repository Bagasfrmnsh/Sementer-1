...
<head>
    ...
    <title>Menghitung Kalkulator</title>
</head>
<body>
<table>
        <form action="" method="post">
            <tr>
                <h2>Menghitung Kalkulator</h2>
...
if (isset($_POST["hitung"])) {
   ...
   $cetak->tambah($angka1,$angka2,$oprasi);
   $cetak->kurang($angka1,$angka2,$oprasi);
   $cetak->kali($angka1,$angka2,$oprasi);
   $cetak->bagi($angka1,$angka2,$oprasi);
